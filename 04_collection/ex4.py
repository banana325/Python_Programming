...
#list comprehension vs generater 표현식
...
# 품목, 가격, 수량 튜플 만들기
a,b,c=tuple(zip(*stocks)) 
print(a)                                                # ✅ ('사과', '바나나', '체리')
print(b)                                                    # ✅ (1000, 2000, 5000)
print(c)                                                    # ✅ (5, 3, 2)
# 총 재고 금액 출력
total=sum(price * num for _,price,num in stocks)                                #name을 _로 바꾸기 가능
