...
print(id(a[0]),id(a[0]))                  # 기존에 캐싱된게 있으면 재사용함
...
print(a[5:-7:-1])                   # 출력 안됨 (step이 음수이면 start가 end보다 커야 함)
...
print(f"{s[:1]}학년 {s[1:2]}반 {(int(s[2:3])*10)+int(s[3:])}번")                  # ✅ "1학년 3반 1번" 출력